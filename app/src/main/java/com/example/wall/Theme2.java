...
public class Theme2 extends AppCompatActivity implements View.OnClickListener{
    ...
    void loadBackgrounds(){
        ...
        backgrounds[0] = R.drawable.space1;
        backgrounds[1] = R.drawable.space2;
        backgrounds[2] = R.drawable.space3;
        backgrounds[3] = R.drawable.space4;

        backgrounds[4] = R.drawable.space5;
        backgrounds[5] = R.drawable.space6;
        backgrounds[6] = R.drawable.space7;
        backgrounds[7] = R.drawable.space8;

        backgrounds[8] = R.drawable.space9;
        backgrounds[9] = R.drawable.space10;
        backgrounds[10] = R.drawable.space11;
        backgrounds[11] = R.drawable.space12;
    }
