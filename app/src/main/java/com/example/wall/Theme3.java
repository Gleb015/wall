...
public class Theme3 extends AppCompatActivity implements View.OnClickListener{
    ...
    void loadBackgrounds(){
        ...
        backgrounds[0] = R.drawable.animals1;
        backgrounds[1] = R.drawable.animals2;
        backgrounds[2] = R.drawable.animals3;
        backgrounds[3] = R.drawable.animals4;

        backgrounds[4] = R.drawable.animals5;
        backgrounds[5] = R.drawable.animals6;
        backgrounds[6] = R.drawable.animals7;
        backgrounds[7] = R.drawable.animals8;

        backgrounds[8] = R.drawable.animals9;
        backgrounds[9] = R.drawable.animals10;
        backgrounds[10] = R.drawable.animals11;
        backgrounds[11] = R.drawable.animals12;
    }
