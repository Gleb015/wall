...
public class Theme6 extends AppCompatActivity implements  View.OnClickListener {
    ...
    void loadBackgrounds(){
        ...
        backgrounds[0] = R.drawable.backgrounds1;
        backgrounds[1] = R.drawable.backgrounds2;
        backgrounds[2] = R.drawable.backgrounds3;
        backgrounds[3] = R.drawable.backgrounds4;

        backgrounds[4] = R.drawable.backgrounds5;
        backgrounds[5] = R.drawable.backgrounds6;
        backgrounds[6] = R.drawable.backgrounds7;
        backgrounds[7] = R.drawable.backgrounds8;

        backgrounds[8] = R.drawable.backgrounds9;
        backgrounds[9] = R.drawable.backgrounds10;
        backgrounds[10] = R.drawable.backgrounds11;
        backgrounds[11] = R.drawable.backgrounds12;
    }
